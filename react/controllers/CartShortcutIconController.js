...
import CartShortcutIconContainer from '../containers/CartShortcutIconContainer';
import {TIMEOUT_RESEST_POPUP_PRODUCT_TO_CART_ADDED} from '../config';
...
export default () => View => {
    ...
    class CartShortcutIconController extends Component {
        ...
        render() {
            console.log('CartShortcutIconController');
        ...
        setTimer() {
            ...
            }, TIMEOUT_RESEST_POPUP_PRODUCT_TO_CART_ADDED);
        }
